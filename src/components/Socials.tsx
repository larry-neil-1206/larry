...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/larry-neil-mcgowen-3798a7265', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/larry-neil-1206', icon: GitHubIcon },
];
