...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Web Engineer</span> with{" "}
          <span className="text-work_experience_orange">10+ years</span> of
          ...
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              <h1 className="font-display text-5xl font-medium tracking-tight [text-wrap:balance] sm:text-6xl">
                Larry Neil <span className="wave">👋</span>
              </h1>
              ...
              <p className="max-w-3xl">
                Fullstack engineer with a B.S. in Computer Science with over 10
                years of hands-on experience in web development.
              </p>
            </FadeIn>
            <Socials />
